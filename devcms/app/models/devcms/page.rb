  ...
  class Page
    ...
    def self.compose(layout_name, var_hash)
      ...
      plain_src = str.gsub(/[" "]*%content:([\w_\-]+)/) { |r|
        ...
        #custom_style = CUSTOM_SCSS_FOLDER + "2" + Devcms::TARGET_DIVIDER + replacement.name + ".scss"
      ...
      seo_string = Source.quick_attach(Devcms::SourceType::LAYOUT, layout_name, Devcms::SourceType::SEO).data
